...
const SearchBox = () => {
    ...
    const handleOnClick = () => {
        ...
        setTimeout(() => {
            document.querySelector(".searchHolder.expanded") ? inputRef.focus() : inputRef.blur();
        }, 700);
    }
        ...
        <>
            <div className='searchHolder'>
                ...
                <Autocomplete
                    ...
                    renderInput={(params) => (
                        <TextField {...params} variant="standard" placeholder='Search For Trek Names' inputRef={input => {
                            inputRef = input;
