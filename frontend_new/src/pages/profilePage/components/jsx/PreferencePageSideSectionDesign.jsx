    ...
    return (
        <>
            <div className="sectionProfileHolder" style={{ flexDirection: "column" }}>
                <PreferenceSelector tag={"State"} valueArray={stateArray} setValue={setState} preferredValue={state} />
                <PreferenceSelector tag={"Season"} valueArray={seasonArray} setValue={setSeason} preferredValue={season} />
                <PreferenceSelector tag={"Difficulty"} valueArray={difficultyArray} setValue={setDifficulty} preferredValue={difficulty} />
